# Author: Lucas Manning <lucassm@princeton.edu> 2022
#
...
def write_state_day_stats(day=None, state=None, polls=None, file=None):
    ...
    date_most_recent_poll = datetime(year=2022, month=1, day=1).strftime("%j")
...
def presidential(polls):
    ...
    all_output = []
    path = os.path.join(dir_path, 'outputs/2022.EV.polls.median.test.txt')
    f = open(path, 'w')
    ...
    path = os.path.join(dir_path, 'outputs/2022.EV.polls.median.test.csv')
